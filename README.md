...
This project covers the full ML engineering lifecycle: exploratory data analysis, preprocessing and feature selection, model training and evaluation, production-ready inference API, containerisation, and data drift monitoring. The goal is not just predictive accuracy, but demonstrating the practices that separate research notebooks from production systems — structured code, proper error handling, meaningful version control, and reproducible pipelines.
